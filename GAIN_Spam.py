...
np.savetxt('spam_results/train.csv',trainX, delimiter=',')
np.savetxt('spam_results/test.csv',testX, delimiter=',',)

np.savetxt('spam_results/train_missing.csv',trainM, delimiter=',')
np.savetxt('spam_results/test_missing.csv',testM, delimiter=',',)
